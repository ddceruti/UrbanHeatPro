...
# --------------------------------------------------------------------------------
	def create_synthetic_city(self):
		...
		if (self.debug >= 1):
			...
			print('         Starting multiprocessing with {}/{} processors...'.format(self.processes, multiprocessing.cpu_count()))
...
# --------------------------------------------------------------------------------		
	def calculate_city_heat_demand(self):
		...
		if (self.debug >= 1):
			...
			print('         Starting multiprocessing with {}/{} available processors'.format(self.processes, multiprocessing.cpu_count()))
